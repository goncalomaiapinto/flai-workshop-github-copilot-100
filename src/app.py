...
activities = {
    ...
    "Debate Club": {
        "description": "Engage in formal debates on various topics and develop argumentation skills",
        "schedule": "Wednesdays, 3:30 PM - 4:30 PM",
        "max_participants": 16,
        "participants": ["rachel@mergington.edu", "tom@mergington.edu"]
    },
    "Robotics Club": {
        "description": "Build and program robots to compete in regional robotics competitions",
